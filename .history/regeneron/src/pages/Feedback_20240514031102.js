            ...
            {!fileUploaded && (
                <div style={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", marginTop:"5%"}}>
                    <div className="onboarding">
                        <h1 style={{fontSize:"50px", marginBottom:"60px"}}>Protocol Burden Scoring</h1>
                    </div>
                    <div className='upload-file' onClick={() => document.getElementById('file-input').click()}>
                        {!fileUploaded && !loading && (
                            <div>
                                <h1 style={{marginTop:"-20px", color:"rgb(78, 78, 78)"}}>Upload your Protocol:</h1>
                                <input
                                    id="file-input"
                                    type="file"
                                    accept=".pdf"
                                    ...
                                    style={{ display: 'none' }}
                                />
                                <img src={Upload} alt="upload" width={"500px"} />
                            </div>
                        )}
                        {loading && (
                    ...
                    <p style={{textOverflow: "ellipsis", whiteSpace: "normal", width: "900px", lineHeight:"35px", color:"rgb(53, 53, 53)"}}>
