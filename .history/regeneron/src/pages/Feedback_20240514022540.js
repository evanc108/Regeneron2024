            ...
            {!fileUploaded && (
                <div style={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", marginTop:"5%"}}>
                    <div className="onboarding">
                        <h1 style={{fontSize:"50px", marginBottom:"70px"}}>Protocol Burden Scoring</h1>
                        <p style={{overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "normal", maxWidth: "400px"}}>
                            askldjfs;k askldjfs;k askldjfs;k askldjfs;kasdlkfa;skdjfl;kasdjfl;kasjdf;lkasj</p>
                    </div>
