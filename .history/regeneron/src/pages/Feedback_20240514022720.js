            ...
            {!fileUploaded && (
                <div style={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", marginTop:"5%"}}>
                    <div className="onboarding">
                        <h1 style={{fontSize:"50px", marginBottom:"40px"}}>Protocol Burden Scoring</h1>
                        <p style={{textOverflow: "ellipsis", whiteSpace: "normal", maxWidth: "1000px"}}>
                            askldjfs;k askldjfs;k askldjfs;k askldjfs;kasdlkfa;skdjfl;kasdjfl;kasjdf;lkasasdlf;kasdf aslkdfjals;kdjf lkajsd faslkd fals;dkf asldk fasl;dk fal sdf l;asd flak sdfklj asd j</p>
                    </div>
