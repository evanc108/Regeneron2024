  ...
  return (
    <div className="App">
      <div style={{backgroundColor: "white", width: "100%", padding: "0.2px", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.1)"}}>
        ...
        <button style={{float: "right", marginRight: "30px", marginTop: "-60px", backgroundColor:"#36d7b7", border:"none", color:"white", padding:"10px 20px 10px 20px", borderRadius:"5px", fontSize:"15px"}}>Login</button>
      </div>
