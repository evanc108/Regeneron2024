  ...
  return (
    <div className="App">
      <div style={{backgroundColor: "white", width: "100%", padding: "0.2px", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.1)"}}>
        ...
        <button style={{ backgroundColor:"#36d7b7", border:"none", color:"white", padding:"10px 30px 10px 30px", borderRadius:"7px", fontSize:"18px", fontWeight:"bold", position: "absolute", top: "0", right: "30" }}>Sign In</button>
      </div>
